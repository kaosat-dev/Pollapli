...
def configure_all():
    ...
    rootPath = os.path.join(rpath,"pollapli")
...
#    if useWebcam:
#         from pollapli.core.logic.components.connectors.webcam.gstreamer_cam import GStreamerCam
...
#         testBottle.webcam = webcamNode
    ...
    from pollapli.core.server import MainServer
