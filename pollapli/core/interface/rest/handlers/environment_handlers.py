...
from pollapli.core.interface.rest.handlers.node_handlers import NodesHandler
from pollapli.core.interface.rest.handlers.task_handlers import TasksHandler
